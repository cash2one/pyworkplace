...
def excel_table_byname(file='Table.xls', colnameindex=0, by_name=u'sql'):
    data = open_excel(file)
    ...
    for row in tables:
        ...
        try:
            ...
            value=[values[u'代码'][2:8],   # STKCODE      varchar(12)
                    ...
                    values[u'开盘'],  # OPNPRC DECIMAL (4, 4) NULL DEFAULT NULL COMMENT '日开盘价',
                    values[u'最高'],       # HIPRC DECIMAL (4, 4) NULL DEFAULT NULL COMMENT '日最高价',
                    values[u'最低'],         # LOPRC        decimal(4,4) NULL DEFAULT NULL COMMENT '日最低价' ,
                    values[u'现价'],    # CLSPRC       decimal(4,4) NULL DEFAULT NULL COMMENT '日收盘价' ,
                    values[u'涨跌'],    # ADV DECIMAL (4, 4) NULL DEFAULT NULL COMMENT '涨跌值',
                    values[u'涨幅%'],    # ADR          decimal(4,4) NULL DEFAULT NULL COMMENT '涨跌率 * 100' ,
                    values[u'总手'],    # VOL DECIMAL (20, 0) NULL DEFAULT NULL COMMENT '日个股交易股数 成交量',
                    ...
                    values[u'外盘'],    # BUYVOL       decimal(10,0) NULL DEFAULT NULL COMMENT '外盘量' ,
                    values[u'内盘'],    # SELLVOL      decimal(10,0) NULL DEFAULT NULL COMMENT '内盘量' ,
